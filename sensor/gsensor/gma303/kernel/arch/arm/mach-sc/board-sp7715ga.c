...
//#include <linux/i2c/kxtj9.h>
#include <linux/input/kxtj9.h>

#endif

#if defined(CONFIG_SENSORS_GMA303)
...
static struct lis3dh_acc_platform_data lis3dh_plat_data = {
	...
	static struct gma_platform_data gma303_plat_data = {
	...
	static struct kxtj9_platform_data kxtj9_plat_data = {
		.init_interval = 10,
		.min_interval = 10,
		.g_range = 0,
		.g_range = 0x00,
...
#if defined(CONFIG_INPUT_KXTJ9)||(defined(CONFIG_INPUT_KXTJ9_MODULE))
        { I2C_BOARD_INFO(KXTJ9_ACC_DEV_NAME, KXTJ9_I2C_ADDR),
	  .platform_data = &kxtj9_plat_data,
	},

#endif

#if defined(CONFIG_SENSORS_GMA303)||(defined(CONFIG_SENSORS_GMA303_MODULE))
        { I2C_BOARD_INFO("gma303", 0x18),
	  .platform_data = &gma303_plat_data,
	},
